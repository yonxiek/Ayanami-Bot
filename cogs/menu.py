...
class MenuView(discord.ui.View):
    ...
    async def select_callback(
        ...
        actions = {
            "Голосования": "**Доступно:** ➕ Создать опрос · 📊 Результаты · 🏁 Завершить",
            "События": "**Доступно:** ➕ Создать · 📋 Список · ❌ Отменить",
            "Карточки": "**Доступно:** 🃏 Выбросить карточку · 📦 Коллекция · ✉️ Передать · ⚖️ Трейд",
            "Кланы": "**Доступно:** ➕ Создать · ℹ️ Мой клан · 🏆 Топ · 🤝 Вступить · 🚪 Покинуть · 💰 Казну · 🎖️ Роли",
            "GitHub": "**Доступно:** 📝 Коммиты · 🔀 Pull Requests · 🐛 Issues",
            "Напоминания": "**Доступно:** ⏰ Создать · 📋 Список · ❌ Удалить",
            "Дни рождения": "**Доступно:** 🎂 Установить · ℹ️ Моя дата · ❌ Удалить",
            "Задачи": "**Доступно:** ➕ Новая · 📋 Мои задачи · ✅ Завершить · ❌ Удалить",
            "Кошелёк": "**Доступно:** 💸 Перевод · 📋 История",
            "Приглашения": "**Доступно:** 📊 Моя статистика · 📋 Кого пригласил",
        }
        embed = discord.Embed(
            title=category,
            description=f"{desc}\n\n{actions[category]}",
    ...
    async def _back(self, interaction: discord.Interaction):
        embed = discord.Embed(
            ...
            description=(
                ...
                "**Доступно:** 📊 Голосования · 🎉 События · 🃏 Карточки · ⚔️ Кланы · "
                "🐙 GitHub · ⏰ Напоминания · 🎂 Дни рождения · 📋 Задачи · 💰 Кошелёк · 🔗 Приглашения"
            ),
            color=0x2B2D31,
        )
