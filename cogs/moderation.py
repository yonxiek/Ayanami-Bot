...
class Moderation(commands.Cog):
    ...
    async def warns(self, interaction: discord.Interaction, member: discord.Member | None = None):
        ...
        embed = discord.Embed(title="### Нарушения", description=f"{target.mention}\n\n{description}", color=discord.Color(0x2b2d31))
        embed.set_footer(text="Ayanami System")
    ...
    async def strikes(self, interaction: discord.Interaction, member: discord.Member | None = None):
        ...
        embed = discord.Embed(title="### Страйки", description=f"{target.mention}\n\n{description}", color=discord.Color(0x2b2d31))
        embed.set_footer(text="Ayanami System")
    ...
    async def history(self, interaction: discord.Interaction, member: discord.Member):
        ...
        embed = discord.Embed(title="История", description=f"{member.mention}\n" + "\n".join(lines), color=discord.Color(0x2b2d31))
