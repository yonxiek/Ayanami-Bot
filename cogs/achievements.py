...
ACHIEVEMENTS = {
    ...
    # --- Тикеты ---
    "first_ticket": ("📩", "Обращение", "Создайте свой первый тикет"),
    "tickets_5": ("🎫", "Постоянный клиент", "Создайте 5 тикетов"),
    # --- Карточки ---
    ...
    # --- Голосования ---
    "first_poll": ("🗳️", "Социолог", "Создайте первое голосование"),
    "poll_vote": ("✅", "Избиратель", "Примите участие в голосовании"),
    # --- События ---
